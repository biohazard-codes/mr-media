...
function Profile() {
  ...
  return (
    <>
      <div className="px-50 flex flex-row justify-between mb-30 ">
        ...
        <button className="flex mt-6 bg-slate-700 text-[18px] py-2 px-6 rounded-2xl shadow shadow-indigo-950 cursor-pointer h-10">
          {" "}
      ...
      <div className="mx-50 w-90 h-87  border-none border-sky-400 rounded-3xl flex flex-col bg-[#192542] pb-20 relative">
        <img
          src="/post.png"
          className="object-cover rounded-3xl border-1 border-sky-400"
        />
